        ...
        if (this.state.visible){
            view = html`
                <sponsor-upload-button class="mb-1">
                    ...
                    <label for="sponsor-upload" class="button -solid -primary -icon w-full -rounded">
                        <i class="icon">
                ...
                <copy-editor loading="eager" class="mb-2" data-lookup="js-sponsor-label">
                    <textarea-component web-component css="textarea-component">
                        ...
                        <textarea id="sponsor-label-textarea-component" rows="5" style="border-radius: 0 0 0.25rem 0.25rem;">Sponsored by</textarea>
                    </textarea-component>
                    <copy-editor-actions style="top: 2rem;">
                        <button state="hidden" class="js-toggle-visiblity-button visibility action" aria-label="enable sponsor" tooltip="Enable">
                        ...
                        <button state="regular" class="js-toggle-bold-button weight action" aria-label="bold sponsor" tooltip="Bold">
                        ...
                        <div>
                            <label class="color action" for="sponsor-color-input" aria-label="sponsor color" tooltip="Font color">
                                <i class="js-color-input-icon" style="background-color: #000;"></i>
                            </label>
                            <input style="opacity: 0;visibility: hidden;position: absolute;" type="color" id="sponsor-color-input" class="js-color-input">
                        </div>
                        <button class="js-enlarge-text-button action" aria-label="Increase font size" tooltip>
                        ...
                        <button class="js-shrink-text-button action" aria-label="Decrease font size" tooltip>
                        ...
                        <text-shadow-button class="js-shadow-button action" tabindex="0" role="button" aria-label="sponsor font shadow" tooltip="Font shadow">
                            <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M432 32a16 16 0 0 1 16 16v96a16 16 0 0 1-16 16h-32a16 16 0 0 1-16-16v-32H264v304h40a16 16 0 0 1 16 16v32a16 16 0 0 1-16 16H144a16 16 0 0 1-16-16v-32a16 16 0 0 1 16-16h40V112H64v32a16 16 0 0 1-16 16H16a16 16 0 0 1-16-16V48a16 16 0 0 1 16-16z"></path></svg>
                            <svg class="shadow" aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path fill="currentColor" d="M432 32a16 16 0 0 1 16 16v96a16 16 0 0 1-16 16h-32a16 16 0 0 1-16-16v-32H264v304h40a16 16 0 0 1 16 16v32a16 16 0 0 1-16 16H144a16 16 0 0 1-16-16v-32a16 16 0 0 1 16-16h40V112H64v32a16 16 0 0 1-16 16H16a16 16 0 0 1-16-16V48a16 16 0 0 1 16-16z"></path></svg>
                        </text-shadow-button>
                        <text-shadow css="text-shadow shadow-position color-picker" tabindex="0" data-lookup="js-sponsor-label">
                            <shadow-position tooltip="Text shadow position">
                                <i data-left="18" data-top="18"></i>
                            </shadow-position>
                            <color-picker class="ml-1" tooltip="Text shadow color">
                                <input type="color" id="sponsor-text-shadow-color">
                                <label for="sponsor-text-shadow-color">
                                    <i style="background-color: #000;"></i>
                                </label>
                            </color-picker>
                            <input type="range" class="js-blur mt-0.5 block w-full" min="0" max="16" step="1" value="0" tooltip="Text shadow softness">
                            <input type="range" class="js-opacity mt-0.5 block w-full" min="0" max="1" step="0.01" value="1" tooltip="Text shadow opacity">
                        </text-shadow>
                    </copy-editor-actions>
                </copy-editor>
            `;
